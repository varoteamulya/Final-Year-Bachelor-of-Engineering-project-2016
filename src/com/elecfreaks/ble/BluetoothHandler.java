...
public class BluetoothHandler {
    ...
    public static BluetoothGattService targetGattService = null;
...
//		while(!BluetoothLeService.flag1){
//			Log.e("inNotofication", ""+BluetoothLeService.flag1);
//		}
//		mBluetoothLeService.setCharacteristicNotification(readGattCharacteristic, false);
	...
	public synchronized void sendData(byte[] value){
    	if(targetGattCharacteristic != null && mBluetoothLeService != null && mConnected == true){
    		int targetLen = 0;
    		//byte value[] = new byte[] {(byte)0xFE,(byte)0xFD,(byte)0xFD,(byte)0xFA,(byte)0x0D,(byte)0x0A};
    		int offset=0;
...
//                	Button scan_1;
//                	scan_1 = MainActivity.scanButton;
//                	scan_1.performClick();
                	
                	//bleDeviceListView.performItemClick(bleDeviceListView.getChildAt(0), 0, bleDeviceListView.getItemIdAtPosition(0));
                }
            });      
        }

		private void scanRecordTest(byte[] scanRecord) {
			// TODO Auto-generated method stub
			int result = ByteBuffer.wrap(scanRecord).getInt();
			System.out.println("ScanRecord:" + result);
		}
    };
